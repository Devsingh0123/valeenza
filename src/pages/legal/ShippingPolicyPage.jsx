        ...
        <div className="mt-6 pt-6 border-t border-stone-400">
                    ...
                    <div className="space-y-4 text-stone-600 text-sm leading-relaxed">
                        <p className="text-justify">
                            This Shipping Policy is subject to change at any time without prior notice. Users are advised to refer to the latest version of this Policy published on www.Valeenza.co before placing any order. For the most current information, please visit the Platform or contact our customer support team.
                        </p>
                    </div>
                </div>
