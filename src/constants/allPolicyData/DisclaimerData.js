  ...
  sections: [
    {
      ...
      body: [
        ...
        {
          type: "paragraph",
          text: "Astrology and related metaphysical practices are interpretative in nature and do not purport to be exact, absolute, or empirically verifiable sciences. The outcomes of any prediction, advice, remedy, or guidance provided through the Platform may vary significantly from person to person based on individual circumstances, interpretation, and personal disposition."
        },
        {
          type: "paragraph",
          text: "Users are strongly advised to exercise their own independent judgment and discretion before making any personal, financial, professional, medical, or legal decisions on the basis of information or consultations obtained through the Platform."
        }
      ]
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "Medical or clinical advice, diagnosis, or treatment recommendations;",
            "Psychological or psychiatric counselling;",
            "Financial, investment, or wealth management advice;",
    ...
    {
      heading: "6. Cultural and Spiritual Nature of Services",
      body: [
        {
          type: "paragraph",
      ...
      body: [
        ...
        },
        {
          ...
          items: [
            ...
            "Financial losses, including loss of income, profits, savings, or business opportunities;",
            "Emotional distress, mental harm, or psychological consequences;",
            "Personal or professional decisions made in reliance on astrological or metaphysical guidance obtained through the Platform;",
            "Loss of data or disruption to access caused by technical failures, force majeure, or third-party service disruptions."
          ]
        },
        {
          type: "paragraph",
    ...
    {
      heading: "9. Third-Party Content and External Links",
      body: [
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "Users who access third-party websites through links on the Platform do so entirely at their own risk and are advised to review the applicable terms, conditions, and privacy policies of those websites before engaging with their content or services."
        }
      ]
    },
    {
      heading: "10. Acceptance of Disclaimer",
      body: [
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "If the User does not accept the terms of this Disclaimer, they must immediately discontinue access to and use of the Platform."
        }
      ]
    },
    {
      heading: "11. Updates to This Disclaimer",
      body: [
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "Users are encouraged to review this Disclaimer periodically to remain informed of its current terms. Continued use of the Platform following any modification to this Disclaimer shall constitute the User's acceptance of the revised terms."
        }
      ]
    },
