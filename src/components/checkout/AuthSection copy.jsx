        ...
        >
          <div className="flex items-center w-full gap-1 ">
            ...
            <input
              ...
              className="flex-1 w-full px-4 py-2.5 text-xs font-semibold tracking-wider border border-gray-200 bg-gray-50/50 rounded-xl focus:outline-none focus:ring-1 focus:ring-sky-50 focus:border-sky-500 transition-all placeholder:normal-case placeholder:font-medium placeholder:text-gray-400"
              required
            />
          </div>
