        ...
        <div className="w-full ">
            ...
            <div className="w-full py-16 flex flex-col justify-center items-center">
                ...
                <div className="text-center mb-6">
                    <span className="inline-flex items-center gap-2 px-4 py-2 bg-sky-100 text-sky-700 text-sm font-medium rounded-full">
                ...
                <div className="flex justify-center items-center gap-2 mb-8">
                    <div className="w-12 h-px bg-sky-300"></div>
                ...
                <div className="max-w-md mx-auto text-center">
                    <div className="bg-white/60 backdrop-blur-sm rounded-xl border border-sky-100">
